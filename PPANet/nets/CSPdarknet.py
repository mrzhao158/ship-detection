...
from nets.attention import mca_block
...
class CSPDarkNet(nn.Module):
    def __init__(self, layers):
        ...
        for m in self.modules():
            if isinstance(m, nn.Conv2d):
                ...
                m.bias.data.zero_()
        self.ECA_1 = mca_block(64)
        self.ECA_2 = mca_block(128)
        self.ECA_3 = mca_block(256)
        self.ECA_4 = mca_block(512)
    ...
    def forward(self, x):
        ...
        out3 = self.ECA_3(out3)
        out4 = self.stages[3](out3)
        out4 = self.ECA_4(out4)
